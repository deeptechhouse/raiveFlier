...
# ─── CLOUD FALLBACK ───────────────────────────────────────────────────
#
# The Whisper API is a cloud-based fallback for when local transcription
# isn't practical (e.g. no GPU, limited RAM, or need for fastest results).
#
...
# for format conversion (unlike the local provider).
# ──────────────────────────────────────────────────────────────────────
"""
...
from tools.raive_feeder.interfaces.transcription_provider import (

...
# behind this common interface so the StoryService doesn't need to know
# which backend is in use.
#
# The story submission flow uses the transcription provider to convert
# audio submissions to text before feeding them into the moderation and
# entity extraction pipeline.
#
# Copied from tools/raive_feeder/interfaces/transcription_provider.py
# and relocated to src/interfaces/ so it's available to the main app's
# DI container without depending on the feeder package.
# ──────────────────────────────────────────────────────────────────────
"""
